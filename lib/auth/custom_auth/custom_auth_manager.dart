...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    version3AuthUserSubject.add(
      Version3AuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<Version3AuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  Version3AuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = Version3AuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    version3AuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
