...
class AppStateNotifier extends ChangeNotifier {
  ...
  Version3AuthUser? initialUser;
  Version3AuthUser? user;
  ...
  void update(Version3AuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const WorldsWidget() : const SplashScreenWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          path: '/registerParent',
          builder: (context, params) => const RegisterParentWidget(),
        ),
        FFRoute(
          name: 'register_teacher',
          path: '/registerTeacher',
          builder: (context, params) => const RegisterTeacherWidget(),
        ),
        FFRoute(
          name: 'Sign_in',
          path: '/signIn',
